...
<div class="cen_sup_g" style=" width:1100px"><div  class="Arial14blanco"  align="left" style="float:left; margin-top:18px;">Bitacora de movimientos</div><div align="right"></div> </div>
...
<table width="900" border="1"  cellpadding="0" cellspacing="0" id="Exportar_a_Excel">
  <tr>
    <td width="66">
    	<div style=" background:url(../img/centro_grid.png);" class=" Arial14Morado"><strong>Usuario</strong></div>
  	</td> 
    <td width="58">
    	<div style=" background:url(../img/centro_grid.png);" class="Arial14Morado"><strong>Acción</strong></div>
  	</td> 
    <td width="97" >
...
<?
$result=mysql_query("select * from tbl_bitacora order by id");
$cont=0;
...
?>
  ...
  <tr>
  <td style=" font-size:10px; font-family:Arial, Helvetica, sans-serif" class="tablas"><?=utf8_encode($row['usuario']);?></td>
  <td style=" font-size:10px; font-family:Arial, Helvetica, sans-serif" class="tablas"><?=utf8_encode($row['accion']);?></td>
  <td style=" font-size:10px; font-family:Arial, Helvetica, sans-serif" class="tablas"><?=utf8_encode($row['fecha']);?></td>
