...
<div class="cen_sup_g" style=" width:1100px"><div  class="Arial14blanco"  align="left" style="float:left; margin-top:18px;">Reporte Existencia minima</div><div align="right"></div> </div>
...
<td width="98">
    	<div style=" background:url(../img/centro_grid.png);" class="Arial14Morado"><strong>Minima</strong></div>
  	</td>
    <td width="97" >
    	<div style=" background:url(../img/centro_grid.png);" class="Arial14Morado"><strong>Unidad</strong></div>
  	</td>
<td width="67">
    	<div style=" background:url(../img/centro_grid.png);" class="Arial14Morado"><strong>Botellas</strong></div>
  	</td>
    <td width="70">
    	<div style=" background:url(../img/centro_grid.png);" class="Arial14Morado"><strong>Total Botellas</strong></div>
  	</td>           
...
<?
$result=mysql_query("select * from tbl_articulos where existencia<=e_minima order by id_categoria");
$cont=0;
