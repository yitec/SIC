...
if($_REQUEST['muestras']==1&&$_REQUEST['oficiales']==1&&$_REQUEST['forrajes']==1){
...
if($_REQUEST['muestras']==1&&$_REQUEST['oficiales']==1&&$_REQUEST['forrajes']==0){
...
if($_REQUEST['muestras']==1&&$_REQUEST['oficiales']==0&&$_REQUEST['forrajes']==1){
...
if($_REQUEST['muestras']==0&&$_REQUEST['oficiales']==1&&$_REQUEST['forrajes']==1){
...
if($_REQUEST['muestras']==1&&$_REQUEST['oficiales']==0&&$_REQUEST['forrajes']==0){
...
if($_REQUEST['muestras']==0&&$_REQUEST['oficiales']==1&&$_REQUEST['forrajes']==0){
...
if($_REQUEST['muestras']==0&&$_REQUEST['oficiales']==0&&$_REQUEST['forrajes']==1){
...
if($_REQUEST['muestras']==0&&$_REQUEST['oficiales']==0&&$_REQUEST['forrajes']==0){
...
$pdf->Cell(40,5,$row['envio_correo'],0,2,'C');
...
$pdf->Cell(190,5,'Deseamos solicitarle nos permita incorporar los resultados de los análisis que usted está solicitando en nuestra base de datos,',0,1,'L');
...
$pdf->Cell(50,5,'Recibió Muestras:  '.$_REQUEST['usuario'],0,0,'L');
$pdf->Cell(70,5,'________________',0,0,'L');
