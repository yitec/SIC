...
if ($_REQUEST['estado']==1){
	...
	$result=mysql_query("select * from tbl_contratos where estado='"."4"."' order by id");
...
?>	
    ...
    //$intervalo = $row['fecha_ingreso']->diff($hoy);
    ...
    if ($intervalo>10){
    ?>
    <td><div align="center" class="Arial14rojo"><?=$row['fecha_ingreso'];?></div></td>
    <?
    }else{
    ?>
