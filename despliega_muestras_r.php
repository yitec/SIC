...
<div class="cen_sup_g">
  <div  class="Arial14blanco" align="left" style="float:left; margin-top:18px;">Reimprimir Etiquetas</div><div align="right"></div> </div>
...
<?
$result=mysql_query("select m.id, m.id_contrato,m.codigo,m.nombreMuestra,m.numero_muestra, c.consecutivo from tbl_muestras m,tbl_contratos c where c.id='".$_REQUEST['id']."' and m.id_contrato=c.consecutivo");
...
?>	
    ...
    <td><div align="center" class="Arial14Negro"><a id="ver" href="ver_analisis_r.php?muestra=<?=$row['numero_muestra'];?>&contrato=<?=$row['id_contrato'];?>&id=<?=$_REQUEST['id'];?>">
     Ver</a>     
    </div></td>  
