...
{	
$result=mysql_query("update tbl_clientes set nombre='".utf8_decode($_REQUEST['txt_nombre'])."',cedula='".$_REQUEST['txt_cedula']."',correo='".$_REQUEST['txt_correo']."',fax='".$_REQUEST['txt_fax']."',direccion='".$_REQUEST['txt_direccion']."',tel_fijo='".$_REQUEST['txt_tel_fijo']."',tel_cel='".$_REQUEST['txt_tel_cel']."',tipo_cliente='".$_REQUEST['cmb_tipo']."',consumible='".$_REQUEST['txt_consumible']."',credito='".$_REQUEST['rnd_credito']."' where nombre='".utf8_decode($_REQUEST['txt_usuario_buscar'])."'");
