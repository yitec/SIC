...
<?
$result=mysql_query("select m.id_contrato,m.codigo,m.nombre_muestra,m.numero_muestra,m.observaciones, c.consecutivo from tbl_muestras m,tbl_contratos c where c.id='".$_REQUEST['id']."' and m.id_contrato=c.consecutivo");
...
?>	
    ...
    <td><div align="center" class="Arial10Negro"><?=$row['observaciones'];?></div></td>
    <td><div align="center" class="Arial14Negro"><a id="ver" href="mantenimiento_analisis.php?muestra=<?=$row['numero_muestra'];?>&contrato=<?=$row['id_contrato'];?>&id=<?=$_REQUEST['id'];?>">
     Ver</a>     
    </div></td>  
