...
if (validado==true){
	top.location.href = 'historial_contrato.php?contrato='+$('#txt_contrato').val();
}
...
<div class="cen_sup_g" style=" width:1100px"><div  class="Arial14blanco"  align="left" style="float:left; margin-top:18px;">Reportes historial contrato</div><div align="right"></div> </div>
