...
<?
    ...
    $result=mysql_query("select * from tbl_contratos where id_cliente=97 order  by id desc");
    ...
    <td><div align="center" class="Arial14Negro"><a href="informe_mag.php?id='.$row['id'].'" target="_blank"><img src="../img/search.png" /></a>
    </div></td>        
    </tr>';
    }
    echo '</table>
