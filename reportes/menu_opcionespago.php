...
if (validado==true){
	top.location.href = 'reporte_tipopago.php?fecha_ini='+$('#fecha_ini').val()+'&fecha_fin='+$('#fecha_fin').val()+'&cmb_ini='+$('#cmb_ini').val()+'&cmb_fin='+$('#cmb_fin').val()+'&cmb_tipoPago='+$('#cmb_tipoPago').val();
}
