...
if (validado==true){
	top.location.href = 'analisis_xCliente.php?fecha_ini='+$('#fecha_ini').val()+'&fecha_fin='+$('#fecha_fin').val()+'&cmb_ini='+$('#cmb_ini').val()+'&cmb_fin='+$('#cmb_fin').val()+'&cmb_cliente='+$('#cmb_cliente').val();
}
...
<div class="cen_sup_g" style=" width:1100px"><div  class="Arial14blanco"  align="left" style="float:left; margin-top:18px;">Reportes An&aacute;lisis por Clientes</div><div align="right"></div> </div>
...
<table>
    ...
    <td><select name="cmb_cliente" id="cmb_cliente" class="combos">
