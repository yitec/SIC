...
<div id="mainBlancoFondo">
	...
	<div align="center" class="Arial18Morado" style="margin-bottom:10px; margin-top:10px;">An&aacute;lisis Bromatolog&iacute;a</div>
      ...
      <table width="747" height="18" border="1"   cellpadding="0" cellspacing="0" bordercolor="#a6c9e2">
        <tr>
         <td width="78"><div align="center" class="azulColumn">C&oacute;digo</div></td>
          <td width="127"><div align="center" class="azulColumn">Fecha Ingreso</div></td>
          <td width="170"><div align="center" class="azulColumn">An&aacute;lisis</div></td>
          <td width="189"><div align="center" class="azulColumn">Observaciones</div></td>
          <td width="90"><div align="center" class="azulColumn">Trabajando</div></td>
          <td width="79"><div align="center" class="azulColumn"> Resultados</div></td>
        </tr>
        <?
		$j=0;
...
$result=mysql_query("  select a.id_contrato,a.codigo,a.fecha_molienda,a.id,c.nombre,a.observaciones, a.id_laboratorio,a.trabajando, a.fecha_rechazado from tbl_analisis a,tbl_categoriasanalisis c where a.id_laboratorio='3' and a.estado='1' and c.id=a.id_analisis order by a.trabajando,a.fecha_molienda");
...
?>
        <tr>
          ...
          <td><div align="center" class="Arial14Negro">
            <input class="trabajando" id="<?=$row['id'];?>"  <? if($row['trabajando']==1){?> checked="checked"<? }?> type="checkbox" value="" />
          </div></td>
