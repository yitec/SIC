...
$result=mysql_query("  select a.codigo,a.fecha_molienda,a.id,c.nombre,a.observaciones, a.id_laboratorio,a.trabajando, a.fecha_rechazado from tbl_analisis a,tbl_categoriasanalisis c where a.id_laboratorio='3' and a.estado='1' and c.id=a.id_analisis order by a.trabajando,a.fecha_molienda");
