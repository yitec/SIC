...
<?
$result=mysql_query("select m.id_contrato,m.codigo,m.id,m.nombre_muestra,m.numero_muestra,m.observaciones, c.consecutivo from tbl_muestras m,tbl_contratos c where c.id='".$_REQUEST['id']."' and m.id_contrato=c.consecutivo");
...
?>	
    ...
    <td><div align="center" class="Arial14Negro"><a id="ver" href="nombre_muestras.php?muestra=<?=$row['numero_muestra'];?>&contrato=<?=$row['id_contrato'];?>&id=<?=$row['id'];?>">
     Cambiar</a>     
    </div></td>  
