...
$(".procesar").live("click", function(event){
		  ...
		  var current_codigo=$(this).attr("codigo");
		  		...
		  		top.location.href = 'ver_analisis_r.php?muestra='+current_muestra+'&contrato='+current_contrato+'&id='+$('#id').val();
...
$result2=mysql_query("select c.nombre,a.id,a.codigo,a.fecha_molienda, a.estado from tbl_analisis a, tbl_categoriasanalisis c where a.id_contrato='".$_REQUEST['contrato']."' and a.id_muestra='".$_REQUEST['muestra']."' and c.id=a.id_analisis order by a.estado");
