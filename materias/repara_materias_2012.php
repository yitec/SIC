...
$resu=mysql_query("select id, fecha_ingreso from bd_sic.tbl_resultados where fecha_ingreso BETWEEN DATE('2012-08-13 00:00:00') and Date('2013-01-22 00:00:00')");
...
if ($encontrado==false){
	echo ("Entro en clasificacion de datos<br>");
