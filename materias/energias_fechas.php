...
if (validado==true){
	...
	top.location.href = 'reporte_energias.php?mes_ini='+$('#mes_ini').val()+'&year_ini='+$('#year_ini').val()+'&mes_fin='+$('#mes_fin').val()+'&year_fin='+$('#year_fin').val()+'&cmb_materia='+$('#cmb_materia').val()+'&proximal='+proximal+'&minerales='+minerales+'&micotoxinas='+micotoxinas+'&energias='+energias;
}
