...
while ($row=mysql_fetch_object($result)){
	...
	if ($row2->nombre==''){
		mysql_query("update tbl_mine2015 set codigo='".$row2->codigo."', nombre='".strTOUPPER($row->nombre_producto)."' where id='".$row->id."'");
	}else{
		mysql_query("update tbl_mine2015 set codigo='".$row2->codigo."', nombre='".$row2->nombre."' where id='".$row->id."'");
	}
