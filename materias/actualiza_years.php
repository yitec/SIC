...
$sql="select id,consecutivo_contrato,id_muestra from tbl_muestras where fecha_creacion>='20150101' and  fecha_creacion<'20160101'";
...
$contador=actualiza_resultado($row->id,$row->consecutivo_contrato,'Extracto Libre Nitrógeno',$row->id_muestra);
...
on res.id_analisis=ana.id
 ...
 cat.nombre='".utf8_decode($analisis)."'
  ...
  and res.consecutivo_contrato='".$consecutivo."'";
	...
	$cont++;
	echo "<br>";
	 $sql3="update tbl_muestras set ".$analisis."='".$row2->resultado."' where id='".$id."' and id_muestra='".$id_muestra."'";
	echo "<br>";
	mysql_query($sql3);
	}
