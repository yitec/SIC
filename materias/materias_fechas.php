...
if (validado==true){
	...
	top.location.href = 'reporte_materias.php?year='+$('#cmb_year').val()+'&materia='+$('#cmb_materia').val();
}
...
<div align="center" class="Arial14Morado">Seleccione la materia Prima</div> 
<div align="center">-------------------------</div> 
<div align="center">
...
while ($row=mysql_fetch_object($result)){
	echo '<option value="'.$row->codigo.'">'.($row->codigo)." - ".utf8_encode($row->nombre).'</option>';
}
?>
</select>
