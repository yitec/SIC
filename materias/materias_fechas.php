...
if (validado==true){
	...
	top.location.href = 'reporte_materias.php?mes_ini='+$('#mes_ini').val()+'&year_ini='+$('#year_ini').val()+'&mes_fin='+$('#mes_fin').val()+'&year_fin='+$('#year_fin').val()+'&cmb_materia='+$('#cmb_materia').val()+'&proximal='+proximal+'&minerales='+minerales+'&micotoxinas='+micotoxinas+'&energias='+energias;
}
...
<div class="cen_sup_g" style=" width:1100px"><div  class="Arial14blanco"  align="left" style="float:left; margin-top:18px;">Reporte Materias Primas entre fechas</div><div align="right"></div> </div>
