...
$("#btn_guardar").live("click", function(event){
 if(confirm('¿Seguro que desea modificar este análisis?')){
...
success: function(datos){			
		...
		top.location.href = 'precios_analisis.php';
...
<div id="mainAzulFondo" align="center" style=" padding:10px;">
  <div id="mainBlacoFondo" >
    ...
    <h2 class="Arial18Morado" >MantenimientoPrecios An&aacute;lisis</h2><div align="left" id="form'+tab_counter+'">
    <table border="0" ><tr>
