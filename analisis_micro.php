...
<div id="mainBlancoFondo">
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <table width="747" height="18" border="1"   cellpadding="0" cellspacing="0" bordercolor="#a6c9e2">
		...
		$result=mysql_query("  select a.codigo,a.fecha_molienda,a.id,c.nombre,a.observaciones, a.id_laboratorio,a.trabajando, a.fecha_rechazado from tbl_analisis a,tbl_categoriasanalisis c where a.id_laboratorio='2' and a.estado='1' and c.id=a.id_analisis order by a.trabajando,a.fecha_molienda");
