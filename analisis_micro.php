...
<div style="margin-left:650px;  margin-top:5px; " ><a href="menu">Men&uacute;</a>&nbsp;-&nbsp;<a href="login.php">Salir</a></div><div id="mainAzulFondo" align="center" style="   height:auto; width:auto;">
<div id="mainBlancoFondo">

	<div align="center" class="Arial18Morado" style="margin-bottom:10px; margin-top:10px;">An&aacute;lisis Microbiolog&iacute;a</div>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <table width="747" height="18" border="1"   cellpadding="0" cellspacing="0" bordercolor="#a6c9e2">
        <tr>
          <td width="78"><div align="center" class="azulColumn">C&oacute;digo</div></td>
          <td width="141"><div align="center" class="azulColumn">Fecha Ingreso</div></td>
          <td width="164"><div align="center" class="azulColumn">An&aacute;lisis</div></td>
          <td width="183"><div align="center" class="azulColumn">Observaciones</div></td>
          <td width="82"><div align="center" class="azulColumn">Trabajando</div></td>
          <td width="85"><div align="center" class="azulColumn"> Resultados</div></td>
        </tr>
        <?
		...
		foreach($v_ids as $i){
			...
			$v_nombres[$j]=utf8_encode($row3['nombre']);
			$j++;
		}
					
		$result=mysql_query("  select a.id_contrato,a.codigo,a.fecha_molienda,a.id,c.nombre,a.observaciones, a.id_laboratorio,a.trabajando, a.fecha_rechazado from tbl_analisis a,tbl_categoriasanalisis c where a.id_laboratorio='2' and a.estado='1' and c.id=a.id_analisis order by a.trabajando,a.fecha_molienda");
        ...
        <tr>
          ...
          <td><div align="center" class="Arial14Negro">
            ...
            <input id="<?=$row['id'];?>" class="trabajando" type="checkbox" value=""
            <? if($row['trabajando']==1){?> checked="checked"<? }?>
             />
          </div></td>
