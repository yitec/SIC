...
function genera_informe($id){
	$result=mysql_query("Select a.*,b.nombre,b.direccion,b.tipo_cliente,b.tel_fijo,b.correo from tbl_contratos as a INNER JOIN tbl_clientes AS b ON a.id_cliente = b.id and a.consecutivo='".$id."'");
...
res.consecutivo_contrato='".$row['consecutivo']."'  order by res.id_laboratorio,ana.id_muestra ");
	...
	/*****************************************Busco los nombres de muestras e imprimo los resultados******************//*****************************************Busco los nombres de muestras e imprimo los resultados******************//*****************************************Busco los nombres de muestras e imprimo los resultados*****************//*****************************************Busco los nombres de muestras e imprimo los resultados******************//*****************************************Busco los nombres de muestras e imprimo los resultados******************/
	$pdf->SetFont('Arial','',5);
	$cont=0;
	$linea=0;
	$posicion=0;
	...
	$pdf->SetY(270);
	$pdf->Cell(0,5,'Página '.$pdf->PageNo(),0,0,'R');
$pdf->Output('C:\AppServ\www\SIC\calidad\archivos\ControlCalidad\informe_'.$consecutivo.'.pdf',F);
