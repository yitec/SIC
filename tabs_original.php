...
<script>
			...
			var pSubanimal="6,10,27,26";
			var pGranos="90,94,111,110";
			var pSubVegetal="174,178,195,194";
			var pPlantas="258,262,279,278";
			var pPastos="342,343,363,352";
			var pAlimento="426,430,447,446";
			var pAguas="567,571,588,587,";
			var pSedimentos="651,655,672,671";
			var pLacteos="736,740,757,756";
			var pMinerales="820,824,841,840";
			var pSemillas="905,909,926,925";			
...
$(function() {
		...
		tabTemplate: "<li><a href='#{href}'>#{label}</a> <span class='ui-icon ui-icon-close'>Remove Tab</span></li>",
			add: function( event, ui ) {
				...
				tab_content ='<div align="center" id="loading'+tab_counter+'"></div><h2 class="Arial18Morado" >Muestra '+muestra_label+'</h2><div align="left" id="form'+tab_counter+'"><table border="0" width="440"><tr><td class="Arial12Azul" width="95">Laboratorio</td><td width="170" align="left" class="Arial12Azul">Categoria</td><td align="left" width="149" class="Arial12Azul">Tipo</td><td align="center" width="131" class="Arial12Azul" >Proximal</td></tr></table><table width="645"><tr><td width="95"><select id="cmb_laboratorio_1_'+tab_counter+'" title="q"><option value="1">Qu&iacute;mica</option></select></td><td><select class="combos" title="q" id="cmb_categoria_1_'+tab_counter+'" onChange="actualiza_tipo(1)"><option value="0">Seleccione</option><option value="1">Subproducto origen animal</option><option value="2">Granos, cereales</option><option value="3">Subproducto origen vegetal</option><option value="4">Plantas, sin procesar</option><option value="5">Pastos y forrajes</option><option value="6">Alimento terminado</option><option value="7">Ensilajes</option><option value="8">Otros</option><option value="9">Aguas</option><option value="10">Sedimentos</option><option value="11">L&aacute;cteos</option><option value="12">Minerales y Suplementos</option><option value="13">Semillas</option></select></td><td><select class="combos" title="q" id="cmb_subcategoria_1_'+tab_counter+'" onChange="cargaAnalisis(1)"></select></td><td align="center" width="130"><input  class="proximal" id="chk_proximal" type="checkbox" value=""></td></tr></table></div><br><div align="left" class="Arial12Azul">Analisis</div><div align="left	" class="muestra_1_'+tab_counter+'"></div><br><div align="left" id="form'+tab_counter+'"><div align="center" class="Arial12Azul">*************************************************************************************************************************************************</div><table border="0" width="440"><tr><td class="Arial12Azul" width="95">Laboratorio</td></tr></table><select title="m" id="cmb_laboratorio_2_'+tab_counter+'"><option value="2">Microbiolog&iacute;a</option></select></div><br><div align="left" class="Arial12Azul">Analisis</div><div align="left	" class="muestra_2_'+tab_counter+'"></div><br><div align="left" id="form'+tab_counter+'"><div align="center" class="Arial12Azul">*************************************************************************************************************************************************</div><table border="0" width="440"><tr><td class="Arial12Azul" width="95">Laboratorio</td></tr></table><select title="b" id="cmb_laboratorio_3_'+tab_counter+'"><option value="3">Bromatolog&iacute;a</option></select></div><br><div align="left	" class="muestra_3_'+tab_counter+'"><br></div><div align="center"  class="Arial12Azul"><div align="left" class="Arial12Azul">Analisis</div><div align="center" class="Arial12Azul">*************************************************************************************************************************************************</div><table width="424"><tr><td align="center" width="207"> Nombre Muestra</td><td align="center" width="205">Observaciones</td></tr></table></div><div align="center"><table><tr><td><textarea id="txt_nombre_'+tab_counter+'" cols="35" rows="3"  class="textArea"></textarea></td><td><textarea id="txt_observaciones_'+tab_counter+'" cols="35" rows="3"  class="textArea"></textarea></td></tr></table></div>';
...
$("#btn_continuar").live("click", function(event){
		...
		async: false,
        url: "operaciones/opr_contratos.php",
        data: "opcion=5&contrato="+$('#txt_contrato').val()+'&muestras='+tab_counter+'&observaciones='+v_observaciones,
        success: function(datos){			
...
<div id="monto" style="float:left;" ></div><div align="right"><a href="#" onClick="addTab()"><img src="img/plus.png" title="Agregar Muestra" width="20" height="20"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onClick="copiarAnalisis(1)"><img title="Copiar muestra anterior" src="img/copy.png" width="20" height="20"></a></div>
<div id="tabs">
	<ul>
...
<div id="tabs-0"   >
	...
	<h2 class="Arial18Morado" >Muestra 1</h2><div align="left" id="form'+tab_counter+'"><table border="0" width="644"><tr><td class="Arial12Azul" width="104">Laboratorio</td><td width="237" align="left" class="Arial12Azul">Categoria</td><td align="left" width="154" class="Arial12Azul">Tipo</td><td align="center" width="131" class="Arial12Azul" >Proximal</td></tr></table><table width="645"><tr><td width="95"><select disabled id="cmb_laboratorio_1_0" title="q"><option value="1">Qu&iacute;mica</option></select></td><td width="240"><select class="combos" title="q" id="cmb_categoria_1_0" onChange="actualiza_tipo(1)"><option value="0" selected >Seleccione</option><option value="1">Subproducto origen animal</option><option value="2">Granos-Cereales</option><option value="3">Subproducto origen vegetal</option><option value="4">Plantas, sin procesar</option><option value="5">Pastos y forrajes</option><option value="6">Alimento terminado</option><option value="7">Ensilajes</option><option value="8">Otros</option><option value="9">Aguas</option><option value="10">Sedimentos</option><option value="11">L&aacute;cteos</option><option value="12">Minerales y Suplementos</option><option value="13">Semillas</option></select></td><td width="151" ><select class="combos" title="q" id="cmb_subcategoria_1_0" onChange="cargaAnalisis(1)"></select></td><td align="center" width="130"><input  class="proximal" id="chk_proximal" type="checkbox" value=""></td></tr></table></div><br><div align="left" class="Arial12Azul">Analisis</div><div align="left	" class="muestra_1_0"></div><br><div align="left" id="form'+tab_counter+'"><div align="center" class="Arial12Azul">*************************************************************************************************************************************************</div><table border="0" width="101"><tr><td class="Arial12Azul" width="95">Laboratorio</td></tr></table><select disabled title="m" id="cmb_laboratorio_2_0"><option value="2">Microbiolog&iacute;a</option></select></div><br><div align="left" class="Arial12Azul">Analisis</div><div align="left	" class="muestra_2_0"></div><br><div align="left" id="form0"><div align="center" class="Arial12Azul">*************************************************************************************************************************************************</div><table border="0" width="440"><tr><td class="Arial12Azul" width="95">Laboratorio</td></tr></table><select disabled title="b" id="cmb_laboratorio_3_0"><option value="3">Bromatolog&iacute;a</option></select></div><br><div align="left" class="Arial12Azul">Analisis</div><div align="left	" class="muestra_3_0"></div><div align="center" class="Arial12Azul">*************************************************************************************************************************************************</div><br>
