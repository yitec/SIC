...
?>        
                       ...
                       <?}?>
                        ...
                        <div  class="ancho_115 rows_centrado"><a id="btn_aprobar" consecutivo="<?=$row->id;?>" class="acciones" href="consulta_pedido.php?id=<?=$row->id?>" title="Consultar"><img src="img/search.png" width="25" height="25" /></a>&nbsp;&nbsp;&nbsp;<a id="aprobar" consecutivo="<?=$row->id;?>" href="#" class="acciones" title="Aprobar"><img src="img/check.png" width="25" height="25" /></a>&nbsp;&nbsp;&nbsp;<a id="btn_rechazar"  consecutivo="<?=$row->id;?>" class="acciones" href="#" title="Rechazar"><img src="img/del.png" width="25" height="25" /></a></div>        
        <?  
