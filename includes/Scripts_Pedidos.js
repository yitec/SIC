...
$("#cmb_tipo").change(function(event){	
    ...
    $("#agregar").hide();
    $('#generico').html('');
    $('#generico').append('<div class="Arial14Morado subtitulos fl">Descripci&oacute;n:</div><div class="Arial14Morado subtitulos fl ml ">Observaciones:</div><br class="none"><div class="fl"><textarea  rows="4" cols="25" name="txt_descripcion_g" id="txt_descripcion_g" ></textarea></div><div ><textarea class="ml"  rows="4" cols="25" name="txt_observaciones_g" id="txt_observaciones_g" ></textarea></div>');
	}	
})
...
function agrega_inputs(nproductos,opcion){
  if (parseInt(opcion)==0){
   opcion=0; 
    ...
    $('#detalle_'+nproductos).append('<div id="generico_'+nproductos+'"><div class="Arial14Morado subtitulos fl">Descripci&oacute;n:</div><div class="Arial14Morado subtitulos fl ml ">Observaciones:</div><br class="none"><div class="fl"><textarea  rows="4" cols="25" name="txt_descripcion_'+nproductos+'" id="txt_descripcion_'+nproductos+'" ></textarea></div><div ><textarea class="ml"  rows="4" cols="25" name="txt_observaciones_'+nproductos+'" id="txt_observaciones_'+nproductos+'" ></textarea></div></div>');
