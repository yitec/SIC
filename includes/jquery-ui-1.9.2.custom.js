...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		monthNames: ['Enero','Febrero','Marzo','Abril','Mayo','Junio',
			'Julio','Agosto','Setiembre','Octubre','Noviembre','Deciembre'], // Names of months for drop-down and formatting
		...
		dayNamesMin: ['Do','Lu','Ma','Mi','Jv','Vi','Sa'], // Column headings for days starting at Sunday
