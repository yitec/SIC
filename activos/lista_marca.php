...
if($tipo_query!=""){
	...
	$query="SELECT * FROM tbl_marca  where id_marca=" .  $ID . " order by marca";
...
<div align="center" class="Arial18Azul" style="margin-bottom:10px; margin-top:10px;"> Lista de Marcas</div>    
	</br>

<div id="div_menu" style="visibility:<?php if($accion=="E" || $accion=="D" ){ echo "hidden"; }else{ echo "visible";} ?>" align="left">

	<a id="busca_marca" href="#"><img src="../img/search_verde.png" alt="Smiley face" height="25" width="25"><span class="Arial14Azul" id="titulo_buscador_marca">Buscador</span></a> 
	&nbsp; &nbsp; &nbsp; &nbsp;
	<a id="guardar_marca" href="#"><img src="../img/add_icon.png" alt="add" height="23" width="23"><span class="Arial14Azul" id="titulo_crear_marca">Crear Marca</span></a>
</div>
	
<input type="hidden" name="tipo_query" id="tipo_query" value="<?php  echo $accion;  ?>">
<input type="hidden" name="ID_MARCA" id="ID_MARCA" value="<?php  echo $ID;  ?>">
<input type="hidden" name="USUARIO" id="USUARIO" value="<?php  echo $_SESSION['nombre_usuario'];  ?>">	
<div style="display:<?php if($accion=="E" || $accion=="D" ){ echo "inline"; }else{ echo "none";} ?>" id="div_ubicacion_marca">
<div>	
	<table border="0" style="width:100%"> 
	   <tr>
		
	    <td>
			<span class="Arial14Negro">Marca</span>
		</td>	
	  </tr>	
	  <tr>		
	  ...
	  <tr>
	   ...
	   <tr>		
	    <td >
			<input name="txt_desc_marca_guardar" <?php  if($accion=="D"){ echo  "readonly"; }  ?> type="text" class="inputbox_ubicacion" id="txt_desc_marca_guardar"  maxlength="200" value="<?php
				if($accion=="E" || $accion=="D"){
					echo $descripcion;
				}			
			?>"/>
	  ...
	  <tr>
		<td align="center">
			<input name="btn_cancelar_marca" id="btn_cancelar_marca" type="image" src="../img/btn_cancelar.png"  />
			<input name="btn_guardar_marca" id="btn_guardar_marca" type="image" src="<?php if($accion!="D"){ echo '../img/btn_guardar.png';}elseif($accion=="D"){ echo '../img/btn_eliminar.png';} ?>"  />
		</td>
	  </tr>
...
<div style="display:none" id="div_marca_buscar">
<div>	
	<table border="0" style="width:100%"> 
	   <tr>
	  ...
	  <tr>
	   ...
	   <tr>		
	    <td >
			<input name="txt_desc_marca_buscar" type="text" class="inputbox_ubicacion" id="txt_desc_marca_buscar"  maxlength="200" />
		</td>			
	  </tr>	
					...
					echo'
					 <tr>
						<td style="width:10%" align="center">
							<div>
								<a class="lnk_grid" href="../activos/lista_marca.php?USS_FX=E_' . $row[0] . '"><img src="../img/pencil.png" alt="delete" height="19" width="19"></a>
							</div>
						</td>
                        <td align="center">' .
                           $row[1] .
