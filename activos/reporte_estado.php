...
<div align="center" class="Arial18Azul" style="margin-bottom:10px; margin-top:10px;"> Reporte:  Total de activos por estado</div>    
	</br>
...
<form action="ficheroExcel.php" method="post" target="_blank" id="FormularioExportacion">
	...
	<input type="hidden" id="Nombre" name="Nombre" value="ReporteEstado" />
	<div id="tabla_datos">
	<?php
		...
		if($query_result){
				...
				while($row = mysql_fetch_array($query_result))
				{
					...
					where ActEst.id_estado =" . $row[0]  . "  order by 1";
