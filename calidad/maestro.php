...
<div id="mainBlancoFondo" style=" width:750px;" align="center">	
    ...
    <div class="maestro_titulo1">Archivo</div></br></br></br>
     <?php				
    while($info=mysql_fetch_array($dt)){
	echo '<div class="maestro_lista1">'.($info[13]).'-'.($info[1]).'</div><div class="maestro_lista">'.utf8_encode($info[4]).'</div><div class="maestro_lista3">'.utf8_encode($info[3]).'</div><div class="maestro_lista">'.utf8_encode($info[6]).'</div><div class="maestro_lista1">'.utf8_encode($info[10]).'</div><div class="maestro_lista1"><a target="_blank" href="'.($info[8]).'">Ver Archivo</a></div>
   </br>';} echo '<br><br><br><br>';?>
    </div>
