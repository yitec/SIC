...
<div id="mainBlancoFondo" style=" width:750px;" align="center">
	<div class="Arial14Negro" style="margin-left:470px; float:left; margin-top:5px;   ">Proveedor:</div>
	...
	<div align="center" class="Arial18Azul" style="margin-bottom:10px; margin-top:10px;">Informaci&oacute;n General Proveedores</div>
	<table>
	  <tr>
	  ...
	  <tr>
	    <td class="Arial14Negro">Marcas</td>
	    <td class="Arial14Negro">Tel&eacute;fono Cel</td>
	    <td class="Arial14Negro">Tel&eacute;fono Fijo</td>
	    </tr>
	  <tr>
	    <td class="Arial14Negro"><input id="txt_marcas" class="inputbox" type="text" /></td>
	  ...
	  <tr>
	    ...
	    <td class="Arial14Negro">Nota</td>
	    </tr>
	  <tr>
	    <td class="Arial14Negro"><input id="txt_fax" class="inputbox" type="text" /></td>
	    <td class="Arial14Negro"><input id="txt_nota" class="inputbox" type="text" /></td>
	    </tr>
	<tr>
	    <td class="Arial14Negro">Contácto</td>
	   
	    <td class="Arial14Negro">Activo</td>
	    </tr>
	  <tr>
	    <td class="Arial14Negro"><input id="txt_contacto" class="inputbox" type="text" /></td>   
	    <td class="Arial14Negro">
			<input type="radio" name="rnd_activo" value="1" id="rnd_activo_1" />
	        Si
	        <input type="radio" name="rnd_activo" value="0" id="rnd_activo_0" />
	        No</td>
	    </tr>
	  <tr>        
	  </table>
...
<script src="includes/Scripts_Proveedores.js" type="text/javascript"></script> 
